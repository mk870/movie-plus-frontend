...
import ApiErrorPage from "../../Pages/ApiErrorPage/ApiErrorPage";


const movieIds = [
  640146, 76600, 505642, 315162, 436270, 603692, 725201, 724495, 661374, 718930,
  536554, 593643,
];
const CarouselComp = () => {
        ...
        <>
          <div className="slidercontent">
            ...
            {recentMovies.map((movie, index) => (
              <div className={currentSlide === index ? "current" : "slide"} key={index}>
                {currentSlide === index && (
                  <div
                    className="card"
